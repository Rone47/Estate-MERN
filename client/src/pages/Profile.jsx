    ...
    <div className='p-3 max-w-xl mx-auto'>
      ...
      <input onChange={(e)=>setFile(e.target.files[0])} type='file' ref={fileRef} hidden accept='image/*' />
        ...
        <p className='text-sm self-center'>
          {fileUploadError ? (
            <span className='text-red-700 font-medium'>Error Image Upload (image must be less than 2mbs)</span>
        ...
        <button className='bg-slate-700 text-white rounded-lg p-3 uppercase hover:opacity-95 disabled:opacity-80 font-semibold'>Update</button>
      </form>
