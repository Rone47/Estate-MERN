    ...
    <div className='p-3 max-w-xl mx-auto'>
      ...
      <input 
       ...
       />
        ...
        <Link className='bg-emerald-700 text-white p-3 rounded-lg uppercase text-center hover:opacity-95' to={"/create-listing"}>
         Create Listing
        </Link>
      </form>
      ...
      <p 
       className='text-red-700 mt-5 '>{showListingsError ? 'Error showing listings' : ''}
      </p>
