  ...
  return (
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
       ...
       <div className='flex flex-col flex-1 gap-4 font-semibold'>
         ...
         <div className='flex gap-4'>
            ...
            <button 
             ...
             className='font-semibold p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80'>
         ...
         <button disabled={loading || uploading} className='font-semibold p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:opacity-80'>
